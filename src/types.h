...
typedef int8_t PieceToHistory[16][64];
typedef PieceToHistory CounterMoveHistoryStat[16][64];

typedef int8_t ButterflyHistory[2][4096];
typedef int16_t CapturePieceToHistory[16][64][8];
typedef int8_t CorrectionHistory[2][16384];
typedef int16_t NonPawnCorrectionHistory[2][2][8192];    // color, stm, table size
